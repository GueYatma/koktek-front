  ...
  return (
    ...
    >
      ...
      <aside
        role="dialog"
        aria-modal="true"
        className={`fixed bottom-6 left-5 right-5 flex max-h-[78vh] w-auto flex-col overflow-hidden rounded-t-3xl rounded-b-[0px] bg-white shadow-2xl transition-transform duration-300 md:bottom-auto md:left-auto md:right-0 md:top-0 md:h-full md:max-h-none md:max-w-md md:rounded-none ${
